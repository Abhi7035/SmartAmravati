package com.example.ash.smartamravati.activity.department.verification;
...
public class DepartVerification extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_depart_verification);
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                ...
                                if (task.isSuccessful()) {
                                    btn_send.setEnabled(false);
                                    Toast.makeText(DepartVerification.this, " Verification Email is Send to :" + FirebaseAuth.getInstance().getCurrentUser().getEmail(), Toast.LENGTH_LONG).show();
                                } else {

                                    Toast.makeText(DepartVerification.this, "Failed to send", Toast.LENGTH_LONG).show();
                                }
                            }
                        });
            }
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                ...
                                if (user.isEmailVerified()== true){
                                    finish();
                                    Toast.makeText(DepartVerification.this, " Verification Successful for => :" + FirebaseAuth.getInstance().getCurrentUser().getEmail(), Toast.LENGTH_LONG).show();

                                    startActivity(new Intent(getApplicationContext(), DepartMenu.class));
                                }else {
                                    Toast.makeText(DepartVerification.this, "Please verify...", Toast.LENGTH_LONG).show();
                                }
                            }
                        });
            }
