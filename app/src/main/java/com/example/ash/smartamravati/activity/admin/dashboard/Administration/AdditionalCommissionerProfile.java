...
public class AdditionalCommissionerProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_additional_commissioner);
        ...
        UserDatabase = FirebaseDatabase.getInstance().getReference().child("Administration").child("Additional Commissioner");
    ...
    private void profilePicSelection() {
        ...
        final CharSequence[] items = {"Take Photo", "Choose from Library",
                "Cancel"};
        AlertDialog.Builder builder = new AlertDialog.Builder(AdditionalCommissionerProfile.this);
    ...
    private void saveProfile() {
        ...
        if (!TextUtils.isEmpty(mName) && !TextUtils.isEmpty(mPost) && !TextUtils.isEmpty(mEmail) && !TextUtils.isEmpty(mMobileNo) && !TextUtils.isEmpty(mAddress) && !TextUtils.isEmpty(mMsg)) {
            ...
            if (imageHoldUri != null) {
                ...
                StorageReference mChildStorage = StorageRef.child("Administration").child("Additional_Commissioner_Profile").child(imageHoldUri.getLastPathSegment());
                ...
                mChildStorage.putFile(imageHoldUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(AdditionalCommissionerProfile.this,"Profile Saved Sucessfully..",Toast.LENGTH_SHORT).show();
                        finish();
                ...
                Toast.makeText(AdditionalCommissionerProfile.this, "Please select the profile pic", Toast.LENGTH_LONG).show();

            }
        } else {

            Toast.makeText(AdditionalCommissionerProfile.this, "Please fill all the fields", Toast.LENGTH_LONG).show();
