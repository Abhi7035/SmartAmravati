...
import com.example.ash.smartamravati.Manifest;
...
public class DepartPdf extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_depart_pdf);
    ...
    private void uploadFile(Uri data) {
        ...
        StorageReference sRef = mStorageReference.child("Administration").child("Department_list").child(Constants.STORAGE_PATH_UPLOADS + System.currentTimeMillis() + ".pdf");
        sRef.putFile(data)
