...
public class LawChairmanProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_law_chairman_profile);
        ...
        UserDatabase = FirebaseDatabase.getInstance().getReference().child("Elected Officials").child("Law Committee Chairman");
    ...
    private void profilePicSelection() {
        ...
        final CharSequence[] items = {"Take Photo", "Choose from Library",
                "Cancel"};
        AlertDialog.Builder builder = new AlertDialog.Builder(LawChairmanProfile.this);
    ...
    private void saveProfile() {
        ...
        if (!TextUtils.isEmpty(mName) && !TextUtils.isEmpty(mPost) && !TextUtils.isEmpty(mEmail) && !TextUtils.isEmpty(mMobileNo) && !TextUtils.isEmpty(mAddress) && !TextUtils.isEmpty(mMsg)) {
            ...
            if (imageHoldUri != null) {
                ...
                StorageReference mChildStorage = StorageRef.child("Elected_Officials_Profile").child("Law_Committee_Chairman_Profile").child(imageHoldUri.getLastPathSegment());
                ...
                mChildStorage.putFile(imageHoldUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(LawChairmanProfile.this,"Profile Saved Sucessfully..",Toast.LENGTH_SHORT).show();
                        finish();
                ...
                Toast.makeText(LawChairmanProfile.this, "Please select the profile pic", Toast.LENGTH_LONG).show();

            }
        } else {

            Toast.makeText(LawChairmanProfile.this, "Please fill all the fields", Toast.LENGTH_LONG).show();
