...
public class StandingChairman extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_standing_chairman);
        ...
        DatabaseReference mChildrefer = mRootRefer.child("Elected Officials").child("Standing Committee Chairman").child("Name");
        DatabaseReference mChildrefer1 = mRootRefer.child("Elected Officials").child("Standing Committee Chairman").child("Designation");
        DatabaseReference mChildrefer2 = mRootRefer.child("Elected Officials").child("Standing Committee Chairman").child("Address");
        DatabaseReference mChildrefer3 = mRootRefer.child("Elected Officials").child("Standing Committee Chairman").child("Email");
        DatabaseReference mChildrefer4 = mRootRefer.child("Elected Officials").child("Standing Committee Chairman").child("Mobile No");
        DatabaseReference mChildrefer5 = mRootRefer.child("Elected Officials").child("Standing Committee Chairman").child("Message");
        DatabaseReference mChildrefer6 = mRootRefer.child("Elected Officials").child("Standing Committee Chairman").child("Profile pic url");
