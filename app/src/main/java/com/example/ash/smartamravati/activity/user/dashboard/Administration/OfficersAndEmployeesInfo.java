...
public class OfficersAndEmployeesInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_officers_and_employees_info);
        ...
        DatabaseReference mChildrefer = mRootRefer.child("Administration").child("Officers and Employees List").child("url");
        ...
        mChildrefer.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                new OfficersAndEmployeesInfo.RetrievePDFStream().execute(url);
    ...
    class RetrievePDFStream extends AsyncTask<String,Void,InputStream> implements OnPageChangeListener, OnLoadCompleteListener {
        ...
        {
            progressDialog = new ProgressDialog(OfficersAndEmployeesInfo.this);
