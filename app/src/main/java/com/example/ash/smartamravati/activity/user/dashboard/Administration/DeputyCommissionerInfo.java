...
public class DeputyCommissionerInfo extends AppCompatActivity {
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_deputy_commissioner_info);
        ...
        DatabaseReference mChildrefer = mRootRefer.child("Administration").child("Deputy Commissioner").child("Name");
        DatabaseReference mChildrefer1 = mRootRefer.child("Administration").child("Deputy Commissioner").child("Designation");
        DatabaseReference mChildrefer2 = mRootRefer.child("Administration").child("Deputy Commissioner").child("Address");
        DatabaseReference mChildrefer3 = mRootRefer.child("Administration").child("Deputy Commissioner").child("Email");
        DatabaseReference mChildrefer4 = mRootRefer.child("Administration").child("Deputy Commissioner").child("Mobile No");
        DatabaseReference mChildrefer5 = mRootRefer.child("Administration").child("Deputy Commissioner").child("Message");
        DatabaseReference mChildrefer6 = mRootRefer.child("Administration").child("Deputy Commissioner").child("Profile pic url");
