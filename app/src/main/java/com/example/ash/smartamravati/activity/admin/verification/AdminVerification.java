package com.example.ash.smartamravati.activity.admin.verification;
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                ...
                                if (task.isSuccessful()) {
                                    btn_send.setEnabled(false);
                                    Toast.makeText(AdminVerification.this, " Verification Email is Send to :" + FirebaseAuth.getInstance().getCurrentUser().getEmail(), Toast.LENGTH_LONG).show();
                                } else {

                                    Toast.makeText(AdminVerification.this, "Failed to send", Toast.LENGTH_LONG).show();
                                }
                            }
                        });
            }
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                ...
                                if (user.isEmailVerified()== true){
                                    finish();
                                    Toast.makeText(AdminVerification.this, " Verification Successful for => :" + FirebaseAuth.getInstance().getCurrentUser().getEmail(), Toast.LENGTH_LONG).show();

                                    startActivity(new Intent(getApplicationContext(), AdminDashboard.class));
                                }else {
                                    Toast.makeText(AdminVerification.this, "Please verify...", Toast.LENGTH_LONG).show();
                                }
                            }
                        });
            }
