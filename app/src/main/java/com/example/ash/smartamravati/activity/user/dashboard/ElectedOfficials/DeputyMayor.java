...
public class DeputyMayor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_deputy_mayor);
        ...
        DatabaseReference mChildrefer = mRootRefer.child("Elected Officials").child("Deputy Mayor").child("Name");
        DatabaseReference mChildrefer1 = mRootRefer.child("Elected Officials").child("Deputy Mayor").child("Designation");
        DatabaseReference mChildrefer2 = mRootRefer.child("Elected Officials").child("Deputy Mayor").child("Address");
        DatabaseReference mChildrefer3 = mRootRefer.child("Elected Officials").child("Deputy Mayor").child("Email");
        DatabaseReference mChildrefer4 = mRootRefer.child("Elected Officials").child("Deputy Mayor").child("Mobile No");
        DatabaseReference mChildrefer5 = mRootRefer.child("Elected Officials").child("Deputy Mayor").child("Message");
        DatabaseReference mChildrefer6 = mRootRefer.child("Elected Officials").child("Deputy Mayor").child("Profile pic url");
