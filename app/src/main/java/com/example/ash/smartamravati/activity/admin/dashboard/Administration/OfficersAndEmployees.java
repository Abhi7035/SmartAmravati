...
public class OfficersAndEmployees extends AppCompatActivity implements View.OnClickListener {
    ...
    private void uploadFile(Uri data) {
        ...
        StorageReference sRef = mStorageReference.child("Administration").child("Officers_and_Employees_list").child(Constants.STORAGE_PATH_UPLOADS + System.currentTimeMillis() + ".pdf");
        sRef.putFile(data)
