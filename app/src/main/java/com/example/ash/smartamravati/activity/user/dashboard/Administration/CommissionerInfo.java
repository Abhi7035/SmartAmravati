...
public class CommissionerInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_commissioner_info);
        ...
        DatabaseReference mChildrefer = mRootRefer.child("Administration").child("Commissioner").child("Name");
        DatabaseReference mChildrefer1 = mRootRefer.child("Administration").child("Commissioner").child("Designation");
        DatabaseReference mChildrefer2 = mRootRefer.child("Administration").child("Commissioner").child("Address");
        DatabaseReference mChildrefer3 = mRootRefer.child("Administration").child("Commissioner").child("Email");
        DatabaseReference mChildrefer4 = mRootRefer.child("Administration").child("Commissioner").child("Mobile No");
        DatabaseReference mChildrefer5 = mRootRefer.child("Administration").child("Commissioner").child("Message");
        DatabaseReference mChildrefer6 = mRootRefer.child("Administration").child("Commissioner").child("Profile pic url");
