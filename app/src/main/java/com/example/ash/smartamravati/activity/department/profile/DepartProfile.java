...
public class DepartProfile extends AppCompatActivity {
    ...
    EditText tittle, name, post, email, mobileNo, address, pincode, DoBirth;
    Button btnSave;
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    finish();
                    Intent moveToHome = new Intent(DepartProfile.this, VerificationActivity.class);
    ...
    private void saveUserProfile() {
        ...
        final String usertittle, username, userpost, useremail,usermobileno, useraddress, userpincode, userdobirth;

        usertittle = tittle.getText().toString().trim();
        username = name.getText().toString().trim();
        userpost = post.getText().toString().trim();
        ...
        if( !TextUtils.isEmpty(usertittle) && !TextUtils.isEmpty(username) && !TextUtils.isEmpty(userpost) && !TextUtils.isEmpty(useremail) && !TextUtils.isEmpty(usermobileno) && !TextUtils.isEmpty(useraddress) && !TextUtils.isEmpty(userpincode) && !TextUtils.isEmpty(userdobirth))
        {
