...
public class Mayor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference mChildrefer = mRootRefer.child("Elected Officials").child("Mayor").child("Name");
        DatabaseReference mChildrefer1 = mRootRefer.child("Elected Officials").child("Mayor").child("Designation");
        DatabaseReference mChildrefer2 = mRootRefer.child("Elected Officials").child("Mayor").child("Address");
        DatabaseReference mChildrefer3 = mRootRefer.child("Elected Officials").child("Mayor").child("Email");
        DatabaseReference mChildrefer4 = mRootRefer.child("Elected Officials").child("Mayor").child("Mobile No");
        DatabaseReference mChildrefer5 = mRootRefer.child("Elected Officials").child("Mayor").child("Message");
        DatabaseReference mChildrefer6 = mRootRefer.child("Elected Officials").child("Mayor").child("Profile pic url");
