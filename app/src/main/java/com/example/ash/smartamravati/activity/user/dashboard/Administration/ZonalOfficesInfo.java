...
public class ZonalOfficesInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zonal_offices_info);
        ...
        DatabaseReference mChildrefer = mRootRefer.child("Administration").child("Zonal_Offices List").child("url");
        ...
        mChildrefer.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                new ZonalOfficesInfo.RetrievePDFStream().execute(url);
    ...
    class RetrievePDFStream extends AsyncTask<String,Void,InputStream> implements OnPageChangeListener, OnLoadCompleteListener {
        ...
        {
            progressDialog = new ProgressDialog(ZonalOfficesInfo.this);
        ...
        public void onPageChanged(int page, int pageCount) {
            ...
            pageNumber = page;
            setTitle(String.format("%s %s / %s","All Zonal Offices.pdf", page + 1, pageCount));
