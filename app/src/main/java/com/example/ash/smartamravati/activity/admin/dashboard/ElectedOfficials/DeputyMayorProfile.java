...
public class DeputyMayorProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_deputy_mayor_profile);
        ...
        UserDatabase = FirebaseDatabase.getInstance().getReference().child("Elected Officials").child("Deputy Mayor");
    ...
    private void profilePicSelection() {
        ...
        final CharSequence[] items = {"Take Photo", "Choose from Library",
                "Cancel"};
        AlertDialog.Builder builder = new AlertDialog.Builder(DeputyMayorProfile.this);
    ...
    private void saveProfile() {
        ...
        if (!TextUtils.isEmpty(mName) && !TextUtils.isEmpty(mPost) && !TextUtils.isEmpty(mEmail) && !TextUtils.isEmpty(mMobileNo) && !TextUtils.isEmpty(mAddress) && !TextUtils.isEmpty(mMsg)) {
            ...
            if (imageHoldUri != null) {
                ...
                StorageReference mChildStorage = StorageRef.child("Elected_Officials_Profile").child("Deputy_Mayor_Profile").child(imageHoldUri.getLastPathSegment());
                ...
                mChildStorage.putFile(imageHoldUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(DeputyMayorProfile.this,"Profile Saved Sucessfully..",Toast.LENGTH_SHORT).show();
                        finish();
                ...
                Toast.makeText(DeputyMayorProfile.this, "Please select the profile pic", Toast.LENGTH_LONG).show();

            }
        } else {

            Toast.makeText(DeputyMayorProfile.this, "Please fill all the fields", Toast.LENGTH_LONG).show();
