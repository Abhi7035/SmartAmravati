...
public class ZonalOffices extends AppCompatActivity implements View.OnClickListener {
    ...
    private void uploadFile(Uri data) {
        ...
        StorageReference sRef = mStorageReference.child("Administration").child("Zonal_Offices_list").child(Constants.STORAGE_PATH_UPLOADS + System.currentTimeMillis() + ".pdf");
        sRef.putFile(data)
