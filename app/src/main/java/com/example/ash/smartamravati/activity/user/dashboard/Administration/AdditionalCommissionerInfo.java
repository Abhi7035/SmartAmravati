...
public class AdditionalCommissionerInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_additional_commissioner_info);
        ...
        DatabaseReference mChildrefer = mRootRefer.child("Administration").child("Additional Commissioner").child("Name");
        DatabaseReference mChildrefer1 = mRootRefer.child("Administration").child("Additional Commissioner").child("Designation");
        DatabaseReference mChildrefer2 = mRootRefer.child("Administration").child("Additional Commissioner").child("Address");
        DatabaseReference mChildrefer3 = mRootRefer.child("Administration").child("Additional Commissioner").child("Email");
        DatabaseReference mChildrefer4 = mRootRefer.child("Administration").child("Additional Commissioner").child("Mobile No");
        DatabaseReference mChildrefer5 = mRootRefer.child("Administration").child("Additional Commissioner").child("Message");
        DatabaseReference mChildrefer6 = mRootRefer.child("Administration").child("Additional Commissioner").child("Profile pic url");
